...
public class TurnSystemTests {
	...
	public void testTurnCharacterPlacedInMap() {
		...
		Enemy e = new Enemy(0, 1, 0, new Position(5, 5), new TurnSystem(new EnemyAI(1)));
	...
	public void testTurnSystemMove() {
		...
		Room r = new Room(new Position(0, 0), new RoomSpace(5, 5), new HashMap<Position, List<Mappable>>());
		Enemy e = new Enemy(1, 1, 0, startLocation, new TurnSystem(new EnemyAI(1)));
	...
	public void testTurnSystemEnterDoor() {
		...
		Player p = new Player(10, 1, 0, new Position(0, 0), ts);
		Room r = new Room(new Position(0, 0), new RoomSpace(3, 3), new HashMap<Position, List<Mappable>>());
	...
	public void testTurnSystemPlayerAttackEnemy() {
		...
		Player p = new Player(10, 1, 1, new Position(0, 0), ts);
		Room r = new Room(new Position(0, 0), new RoomSpace(1, 2), new HashMap<Position, List<Mappable>>());

		r.setPlayer(p.getPosition(), p);

		Enemy e = new Enemy(0, 100, 0, new Position(0, 0), new TurnSystem(new EnemyAI(0)));
	...
	public void testTurnSystemDontEnterDoor() {
		TurnSystem ts = new TurnSystem(new EnemyAI(2));
		Enemy e = new Enemy(1, 1, 0, new Position(1, 1), ts);
	...
	public void testTurnOutOfBounds() {
		...
		Character c = new Character(1, 1, 0, new Position(5, 5), new TurnSystem(new EnemyAI(1)));
		Room r = new Room(new Position(0, 0), new RoomSpace(0, 0), new HashMap<Position, List<Mappable>>());
